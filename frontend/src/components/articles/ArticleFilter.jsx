...
// ===== کلیدهای دسته‌بندی با مسیر درست =====
const categoryKeys = [
  { key: 'all', labelKey: 'articles.categories.all' },
  { key: 'food-stories', labelKey: 'articles.categories.food-stories' },
  { key: 'history', labelKey: 'articles.categories.history' },
  { key: 'culture', labelKey: 'articles.categories.culture' },
  { key: 'city-stories', labelKey: 'articles.categories.city-stories' },
  { key: 'fun-facts', labelKey: 'articles.categories.fun-facts' },
];

export default function ArticleFilter({ activeCategory, onCategoryChange, search, onSearchChange }) {
  const { t } = useTranslation();  // ← مهم: استفاده از t برای ترجمه
